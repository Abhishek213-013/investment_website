  ...
  <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
    <div class="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
      <div class="px-6 py-4 border-b border-gray-200">
        <h3 class="text-lg font-semibold text-gray-800">Create New {{ userTypeLabel }}</h3>
      </div>
      ...
      <form @submit.prevent="$emit('submit')" class="p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div v-if="userType === 'investor'">
            <label class="block text-sm font-medium text-gray-700 mb-2">Initial Investment (Optional)</label>
            <input 
        ...
        <div v-if="userType === 'investor'" class="border-t border-gray-200 pt-4">
          <h4 class="text-sm font-medium text-gray-700 mb-3">Additional Information (Optional)</h4>
          <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
        ...
        <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
          ...
          >
            {{ form.processing ? 'Creating...' : `Create ${userTypeLabel}` }}
          </button>
        </div>
      </form>
    </div>
